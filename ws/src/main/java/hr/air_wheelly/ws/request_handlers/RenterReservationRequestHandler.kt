...
class RenterReservationsRequestHandler(private val context: Context): TemplateRequestHandler<List<PastReservationsResponse>>() {
    ...
    override fun getServiceCall(): Call<SuccessfulResponseBody<List<PastReservationsResponse>>> {
        ...
        return service.getReservationsForMyCars()
    }
}